...
class IncidentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incidente" do
    assert_difference('Incidente.count') do
      post incidentes_url, params: { incidente: { data: @incidente.data, descricao: @incidente.descricao, hora: @incidente.hora, lat: @incidente.lat, long: @incidente.long, tipo: @incidente.tipo } }
    end
  ...
  test "should update incidente" do
    patch incidente_url(@incidente), params: { incidente: { data: @incidente.data, descricao: @incidente.descricao, hora: @incidente.hora, lat: @incidente.lat, long: @incidente.long, tipo: @incidente.tipo } }
